  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 rounded-full bg-accent-primary text-white shadow-lg hover:bg-accent-primary-hover transition-colors flex items-center justify-center z-40"
        title="AI Assistant"
      >
      ...
      >
        ...
        {/* Input */}
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-border-light bg-bg-primary">
          <form
            onSubmit={e => {
              e.preventDefault()
              sendMessage()
